		...
		if( $('#gaugeBasic').get(0) ) {
			var target = $('#gaugeBasic'),
				opts = $.extend(true, {}, {
					...
					colorStart: '#295a91', // Colors
					colorStop: '#295a91', // just experiment with them
