                                ...
                                <tbody>
                                    @foreach ($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <a href="{{ route('view.verification',['verificationId' => $transaction->id]) }}" class="mb-1 mt-1 me-1 btn btn-secondary" style="color: white">
                                                    <span class="hide-mob">View</span> <i class="fas fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach 
