...
<html class="fixed">
    <head>
        ...
        <title>Forgot Password | FamCraft Technologies</title>
            ...
            <div class="center-sign">
                ...
                <div class="panel card-sign">
                    <div class="card-title-sign mt-3 text-end">
                        <h2 class="title text-uppercase font-weight-bold m-0"><i class="bx bx-user-circle me-1 text-6 position-relative top-5"></i> Forgot Password</h2>
                    </div>
                    <div class="card-body">
                        <div class="mb-4 text-gray-600">
                            <p class="mt-3 mb-3">Forgot your password? No problem. Input your email address and we will email you a password reset link if your an account with the email exists.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-end">
                                    <button type="submit" class="btn btn-primary mt-2">Email Password Reset Link</button>
                                </div>
                            </div>
                        </form>
                    </div>
