...
<html class="fixed">
    <head>
        ...
        <title>Confirm Password | FamCraft Technologies</title>
            ...
            <div class="center-sign">
                ...
                <div class="panel card-sign">
                    <div class="card-title-sign mt-3 text-end">
                        <h2 class="title text-uppercase font-weight-bold m-0"><i class="bx bx-user-circle me-1 text-6 position-relative top-5"></i> Confirm Password</h2>
                    </div>
                    <div class="card-body">
