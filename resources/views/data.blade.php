                ...
                <section class="card card-airtime">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-bordered" method="get">
                            ...
                            <div class="form-group row pb-2">
                                <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Data Type</label>
                                <div class="col-lg-6">
                                    <select class="form-control mb-3">
                                        <option>Select Type</option>
                                        <option>2.5GB - &#8358;600</option>
                                        <option>10GB - &#8358;1,500</option>
                                        <option>15GB - &#8358;2,800</option>
                                        <option>25GB - &#8358;10,000</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row pb-4">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="inputDefault" placeholder="Enter amount" value="&#8358;1,500.00" disabled>
                                </div>
                            </div>
                        ...
                        <table class="table table-responsive-md mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="pt-desktop">10GB - &#8358;1,500</td>
