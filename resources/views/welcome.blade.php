...
<html lang="en">
	<head>
		...
		<title>FamCraft Technologies</title>	

		<meta name="keywords" content="Airtime, Data, Cable TV, NIN services, FamCraft" />
		<meta name="description" content="Airtime, Data, Cable TV, NIN services, FamCraft">
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="{{ asset('css/demos/demo-seo-2.css') }}">

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href="{{ asset('css/skins/skin-seo-2.css') }}">
	...
	<body>
							...
							<div class="header-row">
									...
									<div class="header-row">
										<nav class="header-nav-top">
											<ul class="nav nav-pills">
												<li class="nav-item">
													<span class="ws-nowrap custom-text-color-grey-1 text-2 ps-0"><i class="icon-envelope icons text-4 top-3 left-1 me-1"></i> <a href="mailto:support@famcraft.ng" class="text-color-default text-color-hover-primary">support@famcraft.ng</a></span>
												</li>
								...
								<div class="header-column justify-content-end">
									<div class="header-row">
										...
										<a href="tel:+234 816 441 8223" class="btn btn-tertiary font-weight-semibold text-3 px-4 custom-height-1 rounded-0 align-items-center d-none d-md-flex">
											<i class="icon-phone icons text-4 me-2"></i> +234 816 441 8223
										</a>
									</div>
								</div>
							</div>
								...
								<div class="header-row">
												...
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li>
																<a class="nav-link" href="">Airtime Sales</a>
															</li>
															<li>
																<a class="nav-link" href="">Cable Subscription</a>
															</li>
															<li>
																<a class="nav-link" href="">Airtime to Cash</a>
															</li>
														</ul>
													</li>
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="#nin-services">
															NIN Services
														</a>
														<ul class="dropdown-menu">
															<li>
															...
															<li>
																<a class="nav-link" href="">IPE Clearance</a>
															</li>
															<li>
																<a class="nav-link" href="">New Enrollment</a>
															</li>
															<li>
									...
									<div class="header-nav-features header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
										<div class="header-nav-feature header-nav-features-search d-inline-flex">
											<a href="{{ route('login') }}" class="nav-link text-decoration-none"><i class="fas fa-user header-nav-top-icon"></i> &nbsp; Login</a>
										</div>
									</div>
								</div>
							</div>
				...
				<section class="section custom-bg-color-light-1 border-0 pt-5 m-0">
					<div class="container position-relative z-index-1 pt-5 mt-5">
						...
						<div class="row align-items-center pt-4">
							<div class="col-md-6 pb-5 mb-md-5 my-text-center">
								<div class="spacer" style="height: 110px;"></div>
								<h1 class="my-text-center text-color-dark font-weight-bold text-10 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Welcome to FamCraft Technologies</h1>
								<p class="my-text-center custom-text-color-grey-1 text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450">A registered telecommunication company that provide voice or data transmission services.</p>
								<a href="#" class="my-text-center btn btn-secondary font-weight-semibold px-5 py-3 text-3 mb-md-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">GET STARTED</a>
								<div class="spacer d-none d-md-block" style="height: 310px;"></div>
							</div>
							<div class="col-md-6 pb-5">
								<img src="img/landing-img.png" class="landing-img img-fluid position-relative z-index-1 pb-5 mb-5 ms-5 top-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="FamCraft Technology" />
							</div>
						</div>
					</div>
				</section>

				<section id="services" class="section position-relative bg-color-light border-0 m-0">
					...
					<div class="container position-relative custom-negative-margin-1 z-index-3 pb-lg-5 mb-lg-3">
						...
						<div class="row justify-content-center mb-4 minus-mt">
							<div class="col-8 text-center">
								...
								<div class="overflow-hidden">
									<h2 class="font-weight-bold text-color-dark text-7 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="350">Our Services</h2>
								</div>
							</div>
						</div>
						<div class="row align-items-center">
								...
								<div class="row align-items-center">
									<div class="col-md-6">
										<div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="850">
											...
											<div class="card-body text-center pt-5">
												<img src="{{ asset('/img/icons/smartphone.png') }}" class="img-fluid mb-4 pb-2" width="80" height="80" alt="" />
												<h4 class="text-color-dark font-weight-semibold mb-2">Data & Airtimes Sales</h4>
												{{-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci.</p>
												<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a> --}}
											</div>
										</div>
										<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4">
											<div class="card-body text-center pt-5">
												<img src="{{ asset('img/icons/television.png') }}" class="img-fluid mb-4 pb-2" width="80" height="80" alt="" />
												<h4 class="text-color-dark font-weight-semibold mb-2">Cable Subscription</h4>
												{{-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci.</p>
												<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a> --}}
											</div>
										</div>
									...
									<div class="col-md-6">
										<div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
											...
											<div class="card-body text-center pt-5">
												<img src="{{ asset('img/icons/call.png') }}" class="img-fluid mb-4 pb-2" width="70" height="70" alt="" />
												<h4 class="text-color-dark font-weight-semibold mb-2">Airtime to Cash</h4>
												{{-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci.</p>
												<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a> --}}
											</div>
										</div>
										...
										<div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
											<div class="custom-dots-rect-2" style="background-image: url(img/demos/seo-2/dots-group-2.png);"></div>
											<div class="card-body text-center pt-5">
												<img src="{{ asset('img/icons/identity-card.png') }}" class="img-fluid mb-4 pb-2" width="70" height="70" alt="" />
												<h4 class="text-color-dark font-weight-semibold mb-2">NIN Verification</h4>
												{{-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci.</p>
												<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a> --}}
											</div>
										</div>
							...
							<div class="col-lg-5 pt-lg-5 ps-lg-4 mt-lg-5 none minus-d-mt">
								<h2 class="text-color-dark font-weight-semibold text-6 line-height-3 pt-5 mt-5 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">FamCraft Technologies</h2>
								<p class="mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" style="font-size:17px">We are a registered telecommunication company that provide voice or data transmission services such as; Mobile Data, Cable Sub, Eletricity Bill Airtime and so many exciting services.</p>
								<a href="#" class="btn btn-secondary font-weight-semibold px-5 py-3 text-3 mb-md-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">GET STARTED</a>
							</div>
						</div>
					</div>
				</section>

				{{-- <section id="nin-services" class="section position-relative custom-bg-color-light-2 border-0 pt-4 m-0">
					...
					<div class="container position-relative z-index-1 pb-5 mb-5">
						...
						<div class="row justify-content-center mb-4">
							<div class="col-8 text-center">
								<div class="overflow-hidden mb-0 none">
									<span class="d-block line-height-1 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">WHAT WE DO</span>
								</div>
								<div class="overflow-hidden mb-2">
									<h2 class="font-weight-bold text-color-dark text-7 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="350">NIN Services</h2>
								</div>
								<p class="appear-animation none" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur. Sed imperdiet libero id nisi euismod</p>
							</div>
						</div>
						<div class="row justify-content-center pb-2 mb-4">
							<div class="col-md-7 col-lg-4 mb-4 mb-lg-0">
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
									...
									<div class="card-body text-center p-5">
										<img src="{{ asset('img/icons/identity-card.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
										<h4 class="text-color-dark font-weight-semibold mb-3">Verification</h4>
								...
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
									<div class="card-body text-center p-5">
										<img src="{{ asset('img/icons/credible.png')}}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
										<h4 class="text-color-dark font-weight-semibold mb-3">Validation</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
										<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a>
									</div>
								</div>
							...
							<div class="col-md-7 col-lg-4 pt-lg-4 mt-lg-5 mb-4 mb-lg-0">
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">
									<div class="card-body text-center p-5">
										<img src="{{ asset('img/icons/custom-clearance.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
										<h4 class="text-color-dark font-weight-semibold mb-3">IPE Clearance</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
										<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a>
									</div>
								</div>
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">
									<div class="card-body text-center p-5">
										<img src="{{ asset('img/icons/database.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
										<h4 class="text-color-dark font-weight-semibold mb-3">Non Appearance</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
										<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a>
									</div>
								</div>
							...
							<div class="col-md-7 col-lg-4">
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
									<div class="card-body text-center p-5">
										<img src="{{ asset('img/icons/registration-form.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
										<h4 class="text-color-dark font-weight-semibold mb-3">New Enrollment</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
										<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a>
									</div>
								</div>
								<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
									<div class="card-body text-center p-5">
										<img src="{{ asset('img/icons/file.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
										<h4 class="text-color-dark font-weight-semibold mb-3">Modification</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra erat orci, ac auctor.</p>
										<a href="#" class="text-color-secondary font-weight-bold">GET STARTED</a>
									</div>
								</div>
						...
						<div class="row mb-4">
							<div class="col text-center">
								<div class="overflow-hidden">
									<a href="" class="btn btn-secondary btn-outline font-weight-bold px-5 py-3 text-3 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="250">GET A QUOTE</a>
								</div>
							</div>
						</div>
				...
				<section id="contact" class="section bg-color-light position-relative border-0 pt-3 m-0 mb-4">
					...
					<div class="container pb-2 mb-4">
						<div class="row justify-content-center mb-4">
							<div class="col-8 text-center">
								<div class="overflow-hidden mb-0">
									<span class="d-block line-height-1 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">HOW CAN WE HELP YOU?</span>
								</div>
								<div class="overflow-hidden mb-2">
									<h2 class="font-weight-bold text-color-dark text-7 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="350">Contact Us</h2>
								</div>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col-md-10 col-lg-6 mb-5 mb-lg-0">
								<div class="overflow-hidden mb-1">
									<h2 class="text-color-dark font-weight-semibold text-6 line-height-3 mb-4 pe-5 me-5 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="1200" style="animation-delay: 1200ms;">Contact Information</h2>
								</div>
								
								<div class="feature-box align-items-center mb-4 pb-1 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800" style="animation-delay: 1800ms;">
								...
								<div class="feature-box align-items-center mb-4 pb-1 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2000" style="animation-delay: 2000ms;">
								...
								<div class="feature-box align-items-center appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2200" style="animation-delay: 2200ms;">
									<div class="feature-box-icon custom-feature-box-icon-size-1 bg-color-secondary top-0">
							...
							<div class="col-md-10 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="2000" style="animation-delay: 2000ms;">
								<div class="card border-0 custom-border-radius-1 box-shadow-1 p-2">
									<div class="card-body p-4 z-index-1">
										<h4 class="text-color-dark font-weight-semibold text-5 line-height-3 ls-0 mb-1 mt-2 pe-5 me-5">Send Us a Message</h4>
										...
										<form class="contact-form custom-form-style-1" action="php/contact-form.php" method="POST" novalidate="novalidate">
											...
											<div class="row">
												<div class="form-group col mb-3">
													<input type="submit" value="SEND NOW" class="btn btn-secondary font-weight-bold px-5 py-3 text-3" data-loading-text="Loading...">
												</div>
											</div>
										</form>
									</div>
				...
				<div class="container position-relative mt-0 mb-4">
					<div class="row py-5">
						<div class="col-lg-3 mb-5 mb-lg-0">
							<img src="img/logos/logo-white.png" width="200px" class="img-fluid mb-2" alt="FamCraft" />
							<p>We are a registered telecommunication company that provide voice or data transmission services such as; Mobile Data, Cable Sub, Eletricity Bill Airtime and so many exciting services.</p>
						</div>
						<div class="col-lg-3 mb-4 mb-lg-0">
							<h4 class="font-weight-bold text-color-light text-5 ls-0 pb-1 mb-2">NIN Services</h4>
							<ul class="list list-unstyled">
								<li class="mb-1">
									<a href="#">NIN Verification</a>
								</li>
								<li class="mb-1">
									<a href="#">NIN Validation</a>
								</li>
								<li class="mb-1">
									<a href="#">IPE Clearance</a>
								</li>
								<li class="mb-1">
				...
				<div class="footer-copyright bg-color-quaternary">
					<div class="container py-2">
						...
						<div class="row justify-content-center py-4">
							<div class="col-auto">
								<p class="text-color-light opacity-5 text-3">FamCraft Technologies © Copyright 2024. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<!-- Demo -->
		<script src="{{ asset('js/demos/demo-seo-2.js') }}"></script>
