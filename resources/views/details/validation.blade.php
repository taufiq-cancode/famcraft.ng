    ...
    <div class="row mt-desktop">
        <div class="col">
            <section class="card card-airtime">
                ...
                <div class="card-body">
                    <form class="form-horizontal form-bordered" method="POST" action="{{ route('update.validation', ['validationId' => $transaction->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row pb-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="{{ $transaction->validation_category }}" id="inputReadOnly" class="form-control" readonly="readonly">                            
                            </div>
                        </div>

                        <div class="form-group row pb-4">
                            <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Validation Purpose</label>
                            <div class="col-lg-6">
                                <input type="text" value="{{ $transaction->validation_purpose }}" id="inputReadOnly" class="form-control" readonly="readonly">                            
                            </div>
                        </div>
